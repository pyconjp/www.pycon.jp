...
- {iconify}`simple-icons:googleforms data-accent-color=red` [PyCon JP Association運営メンバー申し込みフォーム](https://docs.google.com/forms/d/e/1FAIpQLSeBTd6LQVmPN_orLM8kM9r913UroW6dwRycz83bKNyoZFW3qQ/viewform)
- 参考：{iconify}`simple-icons:blogger data-accent-color=red` [PyCon JP Blog: PyCon JP Associationの運営メンバーを募集します](https://pyconjp.blogspot.com/2020/12/members.html)
...
* {iconify}`simple-icons:twitter data-accent-color=red` **Twitter**: [@ryu22e](https://twitter.com/ryu22e)
* {iconify}`fa-solid:globe data-accent-color=red` **Blog**: [ryu22eBlog](https://ryu22e.org/)
...
* {iconify}`simple-icons:twitter data-accent-color=red` **Twitter**: [@kobatomo3H](https://twitter.com/kobatomo3H)
...
* {iconify}`simple-icons:x data-accent-color=red` **X**: [@yamayama_k5](https://twitter.com/yamayama_k5)
...
* {iconify}`simple-icons:twitter data-accent-color=red` **Twitter**: [@24motz](https://twitter.com/24motz)
...
* {iconify}`simple-icons:twitter data-accent-color=red` **Twitter**: [@yoshi_corleone](https://twitter.com/yoshi_corleone)
...
* {iconify}`simple-icons:twitter data-accent-color=red` **Twitter**: [@Addition_quince](https://twitter.com/Addition_quince)
...
* {iconify}`simple-icons:twitter data-accent-color=red` **Twitter**: [@peacock0803sz](https://twitter.com/peacock0803sz)
* {iconify}`fa-solid:globe data-accent-color=red` **HP**: <https://p3ac0ck.net/>
...
* {iconify}`simple-icons:twitter data-accent-color=red` **Twitter**: [@nana_marux](https://twitter.com/nana_marux)
...
* {iconify}`simple-icons:x data-accent-color=red` **X**: [@rokujyouhitoma](https://x.com/rokujyouhitoma)
* {iconify}`simple-icons:linkedin data-accent-color=red` **LinkedIn**: [Tohru IKE](https://www.linkedin.com/in/tohru-ike-a1b4b328/)
* {iconify}`fa-solid:globe data-accent-color=red` **Site**: [rokujyouhitoma.com](https://rokujyouhitoma.com/)
...
* {iconify}`simple-icons:linkedin data-accent-color=red` **LinkedIn**: [Ikeda Yutaro](https://www.linkedin.com/in/yutaro-ikeda-8b1015147/)
* {iconify}`simple-icons:x data-accent-color=red` **X**: [@ikedaosushi](https://x.com/ikedaosushi)
...
[(株)CMSコミュニケーションズ](https://www.cmscom.jp) 代表
...
PyCon JPはスピーカーも経験し、2025に主催メンバー（ボランティアスタッフ）となる。 2026では共同座長として活動する。

その他コミュニティでは、Startup Weekendのオーガナイザーとして活動。シビックテック分野でも地域課題解決に取り組む。
本業は、家業である自動車金型向け設計事務所にて、製造業におけるデジタル化推進とシステム開発を担当。

趣味は、ものづくりでWebサービスや木工やレザークラフトやIoTや料理と、アウトドアと、音楽のライブに行くこと。

モットーは技術を楽しんで伝えていくこと。

* {iconify}`simple-icons:x data-accent-color=red` **X**: [@hrs_sano645](https://x.com/hrs_sano645)
* {iconify}`fa-solid:globe data-accent-color=red` **Profile**: [aboutme](https://hr-sano.net/aboutme/)
* {iconify}`fa-solid:globe data-accent-color=red` **Blog**: [step by step building](https://hr-sano.net/)
