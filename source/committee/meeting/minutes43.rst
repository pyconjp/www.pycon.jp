...
* 質問事項 (中、相談、nikkie)
  ...
  * 現在のPythonユーザー以外にも裾野を広げるという方向性、Pythonコミュニティ的には受け入れられる？（言葉選びが悪いかもしれません。口頭で補足）
    ...
    * どの言語も裾野が広くて、極めているとがった人がいる。裾野を広げるイベントはPyCon JP以外にもいろいろあると思う。そことの差別化はどうするのか?前からいる人と新しい人の交流があると思う。未来のユーザーだけが来てしまうと、つながりができない心配がある(shimizukawa
...
決算(shimizukawa、中、報告)
---------------------------
* 1/8 羽藤会計事務所へ、決算書作成の依頼(https://pyconjp.atlassian.net/browse/ISSHA-2241)をしました。
