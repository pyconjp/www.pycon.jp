# 2024年1月10日(水) 一般社団法人PyCon JP Association運営会議#64
...
* スポンサー関連
  ...
  * 請求書は全て送付済み(yoshida
  * 2023年度決算としては、未収金で処理し、入金額が海外送金手数料などでずれたら、2024年度で処理しましょう。そのためには吉田さんから会計事務所へ漏れないよう連絡お願いします(shimizukawa)
    * 了解(yoshida)。
* 遠方支援
...
### Guido氏インタラクティブ記念講演会 (terada、低、報告)
